    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('customer', 'Customer'), ('producer', 'Producer'), ('admin', 'Admin')], db_index=True, default='customer', help_text='Defines whether this user is a customer, producer, or admin.', max_length=20)),
